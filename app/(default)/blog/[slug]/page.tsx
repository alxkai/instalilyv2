            ...
            <article>
              ...
              <header className="mb-8">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-xl text-gray-900" data-aos="fade-up" data-aos-delay="200">{post.summary}</p>
                </div>
                {/* Article meta */}
              ...
              <footer>
                <div className="md:flex md:items-center md:justify-between text-center md:text-left">
                  ...
                  <ul className="inline-flex mt-4 md:ml-4 md:mb-0">
                    <li>
                      <Link href="#" className="flex justify-center items-center text-[#F2F2F2] bg-gray-800 hover:text-[#A2F9DA] rounded-full transition duration-150 ease-in-out">
